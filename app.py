...
def getChartData():
    ...
    fIKeys = ['Density', 'Workplaces', 'Residential', 'Retail', 'Grocery', 'Parks',
       'Stations', 'Air quality', 'Water accessibility', 'Thermal anomalies']
    fIvalues = [0.4618791598294936,0.06227403159833104,0.08207634908337734,
    0.03651755018792977,0.039347491857771026,0.09534702713361999,0.07274135115598075,
    0.05524684727075561,0.0688292487723259,0.025740943110414943]
    #feature importance for mobility factors 
    fIMKeys = ['Workplaces', 'Residential', 'Retail', 'Grocery', 'Parks', 'Stations']
    fIMValues = [0.1517348568781475,0.23008026816154137,0.1165129581412859,
    0.14357581125707372,0.17818569824981895,0.17991040731213265]
    
    #univariate selection
    uSKeys = ['Density', 'Workplaces', 'Residential', 'Retail', 'Grocery', 'Parks',
       'Stations', 'Air quality', 'Water accessibility', 'Thermal anomalies']
    uSValues = [36.14733165859195,0.09273469257182483,23.506595629105053,1.2686150850584141,
    2.8919863541195197,0.1988008603787625,2.8880402443913873,0.22619739317656704,
    8.757174296933792,0.018634527564267676]
